import torch
# from transformers import AutoModelForTokenClassification, AutoModelForSequenceClassification, AdamW,
...
class ModelRationalLabel(BertPreTrainedModel):
    ...
    # self.embeddings = AutoModelForTokenClassification.from_pretrained(params['model_path'], cache_dir=params[
    # 'cache_path'])
